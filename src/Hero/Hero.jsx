function Hero() {
    return (
        <div className="relative text-white flex h-fit overflow-hidden">
            <div className="flex flex-col gap-4 relative box-border p-4">
                <h2 className="text-4xl w-full font-bold">Professional Lawn Care Services</h2>
                <div className="flex flex-col gap-4 bg-slate-800 bg-opacity-40">
